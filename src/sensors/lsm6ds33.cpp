...
// Constructors
LSM6DS33::LSM6DS33(int busID, int lsm6ID, LSM6DS33::lsm6Settings settings)
...
LSM6DS33::LSM6DS33(int busID, int lsm6ID)
...
bool LSM6DS33::writeReg(uint8_t* buffer, unsigned short size) {
...
bool LSM6DS33::updateSettings(LSM6DS33::lsm6Settings settings) {
    m_settings = settings;
...
int LSM6DS33::pollData(MasterDataPacket &dp) {
    if (!update())
        return RESULT_FALSE;
...
int LSM6DS33::printValues() const {
    std::cout << "======================================" << std::endl;
...
const char *LSM6DS33::name() const {
